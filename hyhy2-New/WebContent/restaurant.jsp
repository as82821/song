...
<%
	...
	String[] nation={"한식","일식","중식","바/까페","서양식","이색음식점","아시아식","채식전문점","패밀리레스토랑"};
	String[] nation_title={"서울 소재 한국 음식점","서울 소재 일본 음식점","서울 소재 중국 음식점","서울 소재 바/까페","서울 소재 서양 음식점","서울 소재 이색 음식점","서울 소재 아시아 음식점","서울 소재 채식전문점","서울 소재 패밀리 레스토랑"};
%>
<header>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="form-group search-box">
							<form name="search_form" action="restaurant.jsp" method="get">
		...
		<section id="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<div>
							<h3 class="heading font-noto" style="display: inline-block;"><%=nation_title[i] %></h3>
									...
									<div class="col-lg-3">
										<div class="box font-noto venue-wrapper"
											...
											<div class="thumbnail-image">
												<a href="restaurant_detail.jsp?contentid=<%=rdao.contentidlist.get(j) %>">
