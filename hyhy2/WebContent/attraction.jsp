		...
		<section id="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">
						<div>
							<h3 class="heading font-noto" style="display: inline-block;">미술로 떠나는 여행</h3>
							<span style="float: right; margin-top: 20px"><a	href="attraction.jsp" style="font-size: 15px;">더보기</a></span>
						</div>
						<div class="row venue-list" style="float:none;">
							<ul>
								<li>
									<div class="col-lg-3">
										<div class="box font-noto venue-wrapper"
											id="venue_nationwide_1">
											<div class="thumbnail-image">
												<img src="http://tong.visitkorea.or.kr/cms/resource/38/1757338_image2_1.jpg"
													style="background-size: contain;"
													onerror="this.src='../no_image.jpg'">
											</div>
											<h4 id="venue_nationwide_name_1">환기미술관</h4>
											<span class='star'> <span id="star-attraction-1"
												style="width: 70%"></span>
											</span>
											<p id="venue_nationwide_city_1"
												style="display: inline-block; float: right;">서울특별시 종로구 자하문로40길 63</p>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="col-lg-3">
										<div class="box font-noto venue-wrapper"
											...
											<h4 id="venue_nationwide_name_1">한원미술관</h4>
											<span class='star'> <span id="star-attraction-1"
												style="width: 80%"></span>
											</span>
											<p id="venue_nationwide_city_1"
												style="display: inline-block; float: right;">서울특별시 서초구 남부순환로 2423</p>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="col-lg-3">
										<div class="box font-noto venue-wrapper"
											id="venue_nationwide_1">
											<div class="thumbnail-image">
												<img src="http://tong.visitkorea.or.kr/cms/resource/60/696960_image2_1.jpg"
													style="background-size: contain;"
													onerror="this.src='../no_image.jpg'">
											</div>
											<h4 id="venue_nationwide_name_1">조선일보미술관</h4>
											<span class='star'> <span id="star-attraction-1"
												style="width: 90%"></span>
											</span>
											<p id="venue_nationwide_city_1"
												style="display: inline-block; float: right;">서울특별시 중구 세종대로21길 61</p>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="col-lg-3">
										<div class="box font-noto venue-wrapper"
											id="venue_nationwide_1">
											<div class="thumbnail-image">
												<img src="http://tong.visitkorea.or.kr/cms/resource/25/682325_image2_1.jpg"
													style="background-size: contain;"
													onerror="this.src='../no_image.jpg'">
											</div>
											<h4 id="venue_nationwide_name_1">백송갤러리</h4>
											<span class='star'> <span id="star-attraction-1"
												style="width: 80%"></span>
											</span>
											<p id="venue_nationwide_city_1"
												style="display: inline-block; float: right;">서울특별시 종로구 인사동길 31-8</p>
										</div>
									</div>
								</li>											
							</ul>
