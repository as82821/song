...
public class Culture_Art_HistoryJSONTask {
	...
	public String getjson(int pageNo) throws Exception {
		...
		parameter = "&contentTypeId=&areaCode=1&sigunguCode=&cat1=A02&cat2=&cat3=&listYN=Y&MobileOS=ETC&MobileApp=TourAPI3.0_Guide&arrange=A&numOfRows=12&pageNo=";
		// xml형식을 json형식으로 변환
