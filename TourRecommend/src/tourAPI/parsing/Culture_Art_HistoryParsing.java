package tourAPI.parsing;

import org.json.simple.JSONArray;
import org.json.simple.JSONObject;
import org.json.simple.parser.JSONParser;

import tourAPI.jsontask.Culture_Art_HistoryJSONTask;

public class Culture_Art_HistoryParsing {
	public void parsing() throws Exception {
		Culture_Art_HistoryJSONTask json = new Culture_Art_HistoryJSONTask();
		int cnt=0;
		...
		System.out.println("총 "+cnt+"개의 데이터");
	}
}
